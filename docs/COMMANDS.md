...
| `!ova role list|info|create|delete|grant|revoke|inherit|uninherit|assign|remove|temporary|temporarylist|style|template list|preview|apply` · `!ova role discord add|remove|list` · `!ova roles <player>` | Admin/Owner as shown in command help |
