...
| `!ova role list|info|create|delete|grant|revoke|inherit|uninherit|assign|remove|temporary|temporarylist` · `!ova roles <player>` | Admin/Owner as shown in command help |
